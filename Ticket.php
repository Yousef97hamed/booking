<!doctype html>
<html>
<head><link href="Ticketcss.css" rel="stylesheet" type="text/css"> </head>
  ...
  <div class="ticket">
    <div class="ticket__main">
      ...
      <div class="info passenger">
        ...
        <div class="info__detail">الاسم</div>
      </div>
      ...
      <div class="info departure">
        ...
        <div class="info__detail">رقم البـاسبورت</div>
      </div>
      ...
      <div class="info date">
        ...
        <div class="info__detail">1/1/2019</div>
      </div>
      <div class="info time">
        <div class="info__item">FROM</div>
        <div class="info__detail">من</div>
      </div>
      <div class="info carriage">
        <div class="info__item">TO</div>
        <div class="info__detail">الي</div>
      </div>
      <div class="info seat">
