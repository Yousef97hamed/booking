...
<html>
											...
											<form action="Ticket.php" method="post">
                                                ...
                                                <div class="row form-group">
													<div class="col-md-12">
														...
														<select name="air" id="destination" class="form-control">
															<option value="Buraq Airline">Buraq Airline</option>
                                                            <option value="Libyan Airline">Libyan Airline</option>
															<option value="Afriqiyah Airline">Afriqiyah Airline</option>
                                                            <option value="Air Libya">Air Libya</option>
                                                            <option value="Ghadames Airline">Ghadames Airline</option>
                                                            <option value="Air Kufra">Air Kufra</option>
														</select>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														...
														<select name="from" id="destination" class="form-control">
															<option value="Tripoli">Tripoli</option>
															<option value="Benghazi">Benghazi</option>
															<option value="Mesrata">Mesrata</option>
														</select>
													</div>
												</div>
                                                <div class="row form-group">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" name="date" id="date-start" class="form-control">
    ...
    $dbUsername = "root";
       ...
       $sql = "INSERT INTO customer(first_name, passport,Airlines,fromm,too,datee)"
                    . "VALUES ('".$_POST['name']."','".$_POST['passport']."','".$_POST['air']."','".$_POST['fromm']."','".$_POST['too']."','"
           .$_POST['datee']."')";
